/* site-nav.js — navegação compartilhada (nome estático + menu fixo + back link opcional).
   ...
   Atributos:
     ...
     cv          href do "Download CV" (default "Adriana Pommot — Currículo_atualizadoJun2026.pdf"; .pdf vira download)
...
(function () {
  ...
  .nav-menu a{font-size:12px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;padding:9px 18px;border-radius:4px;white-space:nowrap;transition:background .25s,color .25s}
  ...
  class SiteNav extends HTMLElement {
    connectedCallback() {
      ...
      const cv = attr('cv', 'Adriana Pommot — Currículo_atualizadoJun2026.pdf');
