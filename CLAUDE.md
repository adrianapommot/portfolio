...
- **Cache-busting:** ao mudar QUALQUER `.css`/`.js`, subir o `?v=N` em TODAS as páginas que carregam o arquivo. Versões atuais: `home.css?v=3`, `site-nav.js?v=16`, `case-patterns.css?v=12`. Sempre incrementar acima do que está no ar — nunca reverter.
